...
const totalWidth = cmToPixel(23);
const totalHeight = cmToPixel(13);
...
const image2OriginalHeight = totalHeight - (image1Top * 2.3)-200; // Image 2's original height
...
(async () => {
  try {
    ...
    .png()
    .composite([
      { input: processedImage2, top: image2Top, left: Math.round((image2Width) / 0.3) }, // Image 2 is on the complete left and scaled down
